//
//  ResuedSynthesizerInterfaceController.swift
...
class ResuedSynthesizerInterfaceController: WKInterfaceController {
    var timer: Timer?
    ...
    override func awake(withContext context: Any?) {
        ...
        self.timer = Timer.scheduledTimer(withTimeInterval: 1.0, repeats: true, block: { (timer: Timer) in
            ...
            weakSelf.speechSynth.speak(AVSpeechUtterance(string: String(weakSelf.counter)))
